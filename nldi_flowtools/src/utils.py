...
from shapely.geometry import shape, mapping, Point, GeometryCollection, LineString, MultiLineString, Polygon, MultiPolygon
import json
import numpy as np
import math
import sys
...
def project_point(x, y, transformToRaster):
    ...
    if math.isinf(projected_x) is True:
        print('Input point was not properly projected. This could be an error caused by PROJ.')
